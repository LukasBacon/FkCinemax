$(document).ready(function(){
	...
	$("#selectRokZapasy").change(function() {
			...
			success: function(session){
				...
				if (session["admin"] == 1){
					$.ajax({
						...
						/*koniec success ziskanie zapasu*/
					});
					/*koniec servlet ziskanie zapasu*/
				}
				/*koniec admin vypis*/
				else{
					$.ajax({
  	...
  	/*koniec session servlet*/
  	scrollujNaAktualneKolo();
  });
	/*koniec odchytavania zmeny roka*/
	
	/*
	zapasy -> podla skupiny, roku a dnesneho datumu ziskam zo servletu aktualne kolo. 
	Odscrollujem  na toto kolo.
	*/
